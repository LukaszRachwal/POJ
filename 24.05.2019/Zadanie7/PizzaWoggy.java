...
public class PizzaWoggy extends Pizza {
    ...
    public PizzaWoggy(double calories, String name, double price) {
        super(calories, name, price);
    }

    public PizzaWoggy(double calories, String name, double price, String ingredient_1, String ingredient_2, String ingredient_3) {
        super(calories, name, price);
